...
// router.post('/:companyId/update/:foodId',userHandlers.loginRequired, foodHandlers.update);
// router.post('/:companyId/delete/:foodId',userHandlers.loginRequired, foodHandlers.delete);
